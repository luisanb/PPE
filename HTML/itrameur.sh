...
# $ ./programmes/correction_itrameur.sh --> en fait, le chemin de mon ordi
...
do 
	...
	# sinon : < => &lt; => &amp;lt;
	content=$(echo "$content" | sed 's/&/&amp;/g') # s = faire une substitution / ce qu'on remplace / ce qu'on crée / g = globalement 
